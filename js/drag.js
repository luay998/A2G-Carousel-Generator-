...
var _touchMoved=false, _touchTimer=null, _LONG_PRESS_MS=500;
...
function _getCanvasScale(){
  var wrap=document.getElementById('canvasWrap'); if(!wrap) return 1;
...
function selectDomEl(domEl, eid) {
  ...
  /* Desktop only: refresh open prop panel */
...
function _initCanvasClick(){
  ...
  area.addEventListener('touchstart',function(e){ if(!e.target.closest('.drel')) _desel(e); },{passive:true});
}
