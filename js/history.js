...
function pushHistory() {
  ...
  _histStack.push(JSON.stringify({
    slides: slides, activeSlideIdx: activeSlideIdx, AC: AC, BG: BG
  }));
...
function _updateHistBtns() {
  ...
  ['btn-undo','mb-undo'].forEach(function(id) {
    var b = document.getElementById(id); if(b) b.style.opacity = uOp;
  });
  ['btn-redo','mb-redo'].forEach(function(id) {
    var b = document.getElementById(id); if(b) b.style.opacity = rOp;
  });
}
