function saveProject(){
  try{
    var data=JSON.stringify({v:2,slides:slides,AC:AC,BG:BG,
      activeBgPreset:activeBgPreset,slideCounter:slideCounter,elCounter:elCounter},null,2);
  ...
  inp.onchange=function(e){
    ...
    r.onload=function(ev){
      try{
        ...
        if(!data.slides||!Array.isArray(data.slides))throw new Error('Invalid file');
        pushHistory();
